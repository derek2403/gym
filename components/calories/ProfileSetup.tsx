...
export default function ProfileSetup({ initial, onSave, onCancel }: ProfileSetupProps) {
  ...
  return (
    <Card className="space-y-4">
      <h3 className="text-sm font-semibold text-zinc-200">Set up your profile</h3>
      <p className="text-xs text-zinc-500">
        We need a few details to calculate your daily calorie target.
      </p>
      ...
      <Select
        ...
        options={[
          { value: "aggressive_cut", label: "Aggressive Cut (-1000 cal)" },
          { value: "cut", label: "Cut (-500 cal)" },
          { value: "maintenance", label: "Maintenance" },
          { value: "bulk", label: "Bulk (+300 cal)" },
        ]}
      />
